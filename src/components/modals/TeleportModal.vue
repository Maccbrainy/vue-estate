<template>
  <teleport to="body">
    <section
      ...
      :class="{
        'transparent-black': teleportModalMediaTable,
    ...
    >
      <div
        ...
        :class="{
          'w-11/12 h-5/6  m-auto -bottom-14': teleportModalMediaTable,
          'w-full lg:w-5/12 lg:h-5/6 h-full top-14 mx-auto pb-2':
      ...
      >
        <div
          ...
          "
          class="fixed w-11/12 z-10 bg-white rounded-lg"
        >
          <div
              ...
              {{
                ...
                | ${
                  storeData.propertyDetailed.beds == 0
                    ? "Studio"
                    : storeData.propertyDetailed.beds > 0
                    ? storeData.propertyDetailed.beds
                    : ""
                } | ${
                  storeData.propertyDetailed.baths > 0
                    ? storeData.propertyDetailed.baths
                    : ""
                }`
              }}
            </div>
