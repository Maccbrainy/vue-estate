  ...
  <div class="relative my-4 w-full">
    <ul class="flex items-center m-auto">
      <li
        ...
        class="w-1/2 -mx-4"
      >
        <div :id="title" class="text-base font-medium text-gray-700">
          <div 
          :class="{
            'w-full bg-white border rounded-lg z-10': title == `In-Person`,
            'bg-gray-100 hover:bg-gray-200  hover:z-0': title == `Video Chat`,
