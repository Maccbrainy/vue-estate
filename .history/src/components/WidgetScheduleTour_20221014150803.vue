<template>
  <div class="relative my-4 border rounded-lg w-full">
    <div class="flex">
      <div v-for="title in ['In-Person', 'Video Chat']" :key="title">
        <button
          :id="title"
          type="button"
          class="w-full flex-auto border rounded-lg text-base font-medium text-gray-700 px-5 py-2"
        >
          {{ title }}
        </button>
      </div>
