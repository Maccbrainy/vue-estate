    ...
    >
      <thead>
        <tr class="w-full py-3 text-gray-600">
          <th 
            ...
            :key="title" 
            :class="
              `w-[1/${propertyTableHeaderTitle.length}]`
            " 
      ...
      <tbody class="bg-white">
        ...
        >
          ...
          <td class="w-auto py-2 px-4">{{ propertyHistory.price ||  propertyHistory.tax }}</td>
          <td class="w-auto py-2 px-4">
  ...
  setup(props) {
    ...
    const getValueIfPropertyExist = computed(() => {
      ...
      if (props.propertyTitle == "Tax History"){
        valueProperty = Object.hasOwn(props.propertyContentData[0], "assessment");
        console.log("HAS PROPS:", valueProperty);
      }
