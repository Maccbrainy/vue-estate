...
export default {
  ...
  setup(_, context) {
    ...
    const moveSlide = (direction) => {
      ...
      let containerWidthLength = dateContentWidthRef.value.offsetWidth;
      // let containerWidthLength = dateContentWidthRef.value.clientWidth;
      if (direction === 1) {
        moveSlideDirectionIndex.value -= containerWidthLength;
      }
      if (direction === -1) {
        moveSlideDirectionIndex.value += containerWidthLength;
      }
      ...
      isChevronRightVisibility.value =
        remainderOfOverAllScrollWidthLength > containerWidthLength
          ? true
          : false;
    };
    ...
    onMounted(() => {
      ...
      let containerWidthLength = dateContentWidthRef.value.clientWidth;
      isChevronRightVisibility.value =
        containerWidthLength >= contentScrollWidth ? false : true;
        console.log("Client Width:", containerWidthLength);
