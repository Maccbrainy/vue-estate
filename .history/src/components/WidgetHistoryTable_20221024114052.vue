          ...
          >
            <div class="flex flex-row">
              <div class="w-9/12 flex flex-col">
                <span v-if="propertyHistory.date" class="w-auto px-4 font-semibold text-gray-700">
                  {{ format(new Date(propertyHistory.date), " d/M/yyy")}}
                </span>
                <span v-if="propertyHistory.event_name" class="w-auto px-4 font-semibold text-gray-700">
