<template>
  <div
    ...
    class="flex flex-row space-x-4 whitespace-nowrap"
  >
    <div
      v-bind:class="{
        'bg-gray-200 w-16 h-5 ': fetchingIsBusy,
      }"
    >
      <div
    ...
    >
      <div v-if="bathProperty && !fetchingIsBusy" class="flex flex-row align-center">
        <bath-icon class="h-5" />
        <div class="ml-1 text-base font-normal text-gray-600">
          {{ bathProperty }}
        </div>
    ...
    >
      <div v-if="propertySqft && !fetchingIsBusy" class="flex flex-row align-center">
