<template>
    ...
    <form v-on:submit.prevent="submitForm">
      ...
      <div class="text-xs text-teal pt-3">By pressing Schedule A Tour, you agree that Vue Estate and real estate professionals may contact you via phone/text about your inquiry, which may involve the use of automated means. You are not required to consent as a condition of purchasing any property, goods or services. Message/data rates may apply. You also agree to our Terms of Use Vue Estate does not endorse any real estate professionals </div>
    </form>
  </template>
  <script>
  import { ref } from "vue";
