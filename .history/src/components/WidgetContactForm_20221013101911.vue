...
export default {
  ...
  setup() {
    ...
    watchEffect(() => {
      console.log("getDateAndTime:", getDateAndTime.value);
    });
    ...
    const onSubmit = () => {
      ...
      userData.scheduledDate = date;
      // userData.scheduledTourTime = format(getDateAndTime.value, "hh:mm a");
