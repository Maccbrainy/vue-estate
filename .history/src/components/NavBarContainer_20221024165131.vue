<template>
  ...
  >
    ...
    <vue-estate-logo class="sm:py-3 sm:pr-5 cursor-pointer w-full flex justify-start"></vue-estate-logo>
    <slot></slot>
    <menu-icon v-on:click="toggleMenu = !toggleMenu" class="w-8"></menu-icon>
