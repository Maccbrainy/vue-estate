<template>
  <div class="flex relative justify-center">
    <div class="relative w-full lm:w-96 rounded-lg bg-white overflow-hidden mx-auto cursor-pointer">
      <widget-save-share
      ...
      <div class="grid grid-cols-4 grid-rows-2 gap-4 transform transition-all hover:scale-105">
        <div
          v-bind:class="{
