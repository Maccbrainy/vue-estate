...
export default {
  ...
  setup() {
    ...
    const getModalMediaTable = () => {
      ...
      updateRouterParams.state_code = route.slug;
      updateRouterParams.city = route.city;
      updateRouterParams.postalCode = route.postalCode;
      updateRouterParams.propertyId = route.propertyId;
      updateRouterParams.address = route.address;
