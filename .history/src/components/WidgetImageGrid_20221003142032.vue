  ...
  <div class="flex relative overflow-hidden justify-center">
    <div class="w-full lm:w-9/12 mx-auto cursor-pointer">
      <div class="grid grid-cols-4 grid-rows-2 gap-4">
        <div
          v-bind:class="{
            'animate-pulse bg-gray-200': storeData.fetchingIsBusy && propertyImages.length == 0,
          }"
          class="
            relative
            lm:rounded-l-xl
        ...
        <div v-bind:class="{
            'animate-pulse bg-gray-200': storeData.fetchingIsBusy && propertyImages.length < 1,
        ...
        <div v-bind:class="{
            'animate-pulse bg-gray-200': storeData.fetchingIsBusy && propertyImages.length < 2,
