  ...
  <li>
    <div ref="menuRef" class="mr-2">
      ...
      >
        ...
        <span v-if="isComplexDropdown" class="hidden lm:flex lm:items-center">
          <span
...
export default {
  ...
  setup(props) {
    ...
    const isComplexDropdown = computed(() =>
      props.isAdvanceDropdown ? true : false
    );
