    ...
    >
      <thead>
        <tr class="w-full py-3 text-gray-600">
          <th v-for="title in propertyTableHeaderTitle" :key="title" :class="{
            'w-1/5': propertyTableHeaderTitle == 5,
            'w-1/4': propertyTableHeaderTitle == 4,
            'w-1/3': propertyTableHeaderTitle == 3,
            'w-1/2': propertyTableHeaderTitle == 2,
            'w-full': propertyTableHeaderTitle == 1,
