<template>
  <div class="flex flex-row space-x-4 whitespace-nowrap">
    <div
      v-bind:class="{
        'bg-gray-200 w-14 h-5 ': fetchingIsBusy,
      }"
    >
      <div v-if="false" class="flex flex-row align-center">
    ...
    <div
      v-bind:class="{
        'bg-gray-200 h-5': fetchingIsBusy,
      }">
      <div v-if="propertySqft" class="flex flex-row align-center">
