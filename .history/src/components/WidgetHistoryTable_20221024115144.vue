        ...
        >
          ...
          >
            <div class="flex flex-row">
              <div class="w-9/12 flex flex-col xs:px-2 px-4">
                <span v-if="propertyHistory.date" class="w-auto font-semibold text-gray-700">
                  {{ format(new Date(propertyHistory.date), " d/M/yyy")}}
                </span>
                <span v-if="propertyHistory.event_name" class="w-auto font-semibold text-gray-700">
              ...
              <div class="w-3/12 flex flex-col px-4">
                <span v-if="propertyHistory.price" class="w-auto  font-semibold text-gray-700">
                  {{ `Price: $${addCommaToNumberFormat(propertyHistory.price)}` }}
                </span>
                <span class="w-auto xxs:hidden">
