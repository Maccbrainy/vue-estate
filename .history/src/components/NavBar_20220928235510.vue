  ...
  <nav-bar-box>
    ...
    <nav-bar-item>
      ...
      <nav-bar-dropdown v-if="currentSearchedData">
        ...
        <nav-bar-dropdown-item 
          ...
          <router-link 
          :to="`/new-for-rent-properties/${storeData.searchedData.state_code}/`">
    ...
    <nav-bar-item>
      ...
      <nav-bar-dropdown v-if="currentSearchedData">
        ...
        <nav-bar-dropdown-item class="hover:bg-gray-200">
          <router-link to="/mortgages/pre-qualified">Get Pre-Qualified</router-link>
        </nav-bar-dropdown-item>
        <nav-bar-dropdown-item class="hover:bg-gray-200">
          <router-link :to="`/mortgage-rates/${storeData.searchedData.city},${storeData.searchedData.state_code}/`">Mortgage Rates</router-link>
        </nav-bar-dropdown-item>
        <nav-bar-dropdown-item class="hover:bg-gray-200">
          <router-link :to="`/refinance-rates/${storeData.searchedData.city},${storeData.searchedData.state_code}/`">Refinance Rates</router-link>
        </nav-bar-dropdown-item>
        <nav-bar-dropdown-item class="border-t hover:bg-gray-200">
