      ...
      <tbody class="bg-white">
        ...
        >
          <td
            ...
            colspan="1"
            v-bind:class="{ 'md:hidden': propertyTableHeaderTitle.length > 3 }"
          >
            <div class="flex flex-row">
              <div class="w-9/12 flex flex-col">
                <span v-if="propertyHistory.date" class="w-auto py-1 px-4">
                  {{ format(new Date(propertyHistory.date), " d/M/yyy")}}
                </span>
                <span v-if="propertyHistory.event_name" class="w-auto py-2 px-4">
              ...
              <div class="w-3/12 flex flex-col">
                <span v-if="propertyHistory.price" class="w-auto py-1 px-4">
                  {{ `Price: $${addCommaToNumberFormat(propertyHistory.price)}` }}
                </span>
                <span class="w-auto py-2 px-4">
          ...
          <td v-else-if="propertyHistory.assessment" class="w-auto py-2 px-4 sf:hidden">
            ${{ addCommaToNumberFormat(propertyHistory.assessment.total) }}
          </td>
          <td v-else class="w-auto py-2 px-4 sf:hidden">
            {{ `N/A` }}
          </td>
          ...
          <td v-if="propertyHistory.tax" class="w-auto py-2 px-4 sf:hidden">
