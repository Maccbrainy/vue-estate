<template>
  <form v-on:submit.prevent="onSubmit">
    <contact-form-input
      v-model:data-value="getTimeValue"
      labelName="Time"
      typeName=""
      placeholder="Select Time"
      inputName="time"
      warningInfo="Please select tour time"
...
export default {
  ...
  setup(props) {
    const getTimeValue = ref("9:10 PM");
    ...
    watchEffect(() => {
      console.log("Props working time:", props.timeOptions[0].time);
    })
