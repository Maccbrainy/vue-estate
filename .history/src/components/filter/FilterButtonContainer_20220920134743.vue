  ...
  <div class="sticky top-16 w-full h-16 bg-white z-40">
    <div class="flex align-center px-4 pt-2 pb-4 mb-2">
      <button-box class="mf:justify-between">
        ...
        <filter-button-price-range :key="$route.path" class="mf:hidden">
        </filter-button-price-range>
        <filter-button-bedrooms :key="$route.name" class="mf:hidden"></filter-button-bedrooms>
        <filter-button-pets :key="$route.name" class="mf:hidden"></filter-button-pets>
            ...
            <div class="mr-2">
              <button-slot 
                ...
                <span class="md:hidden xs:text-sm flex items-center">
                  <span v-show="!storeData.filterDescriptionInfo.filterIsActive"><filter-icon/></span>
                  <span
