...
export default {
  ...
  setup() {
    ...
    onBeforeMount(() => {
      ...
      //   store.commit("setMinPriceRange", route.query.priceMin);
      //   console.log("ONMOUNTED priceMin:", route.query.priceMin);
      // }
      // if (route.query.priceMax) {
      //   store.commit("setMaxPriceRange", route.query.priceMax);
      //   console.log("ONMOUNTED priceMax:", route.query.priceMax);
      // }
      console.log("THIS IS PRICE ONBEFOREMOUNT:", router);
    })
