...
export default {
  ...
  setup() {
    ...
    // const defaultMinPrice = ref(null);
    // const defaultMaxPrice = ref(null);
    ...
    // watchEffect(() => {
    //   defaultMinPrice.value = getMinPriceRange.value || "0";
    //   defaultMaxPrice.value = getMaxPriceRange.value || "0";
    //   console.log("PRICE DEFAULT WATCHEFFECT REACTED:", defaultMinPrice.value);
    // });
    const defaultMinPrice = computed(() => 
      getMinPriceRange.value ? getMinPriceRange.value : "0");
    const defaultMaxPrice = computed(() => 
      getMaxPriceRange.value ? getMaxPriceRange.value : "0");

    const selectedMin = ref(defaultMinPrice.value);
    const selectedMax = ref(defaultMaxPrice.value);
    ...
    watchEffect(() => {
      ...
      console.log("PRICE MIN WATCHEFFECT REACTED:", minPrice);
      console.log("PRICE MAX WATCHEFFECT REACTED:", maxPrice);
