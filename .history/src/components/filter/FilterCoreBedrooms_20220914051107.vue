...
export default ({
  ...
  setup() {
    ...
    const bedRoomFilterValue = computed(() =>
      storeData.value.propertyFilters.numberOfBed.value 
        ? storeData.value.propertyFilters.numberOfBed.value 
        : bedOptions[0].id);
    ...
    watchEffect(() => {
      let titleFilter = storeData.value.propertyFilters.numberOfBed.value 
        ? `${storeData.value.propertyFilters.numberOfBed.value}+ Beds`  
        : bedOptions[0].id;
