...
export default {
  ...
  setup() {
    ...
    const priceRanges = computed(() => {
      ...
      console.log("PRICE000000000 SWITCH REACTED!!!")
      // resetRangeValues();
    ...
    watchEffect(() => {
      ...
      selectedMin.value = storeData.value.propertyFilters.priceMinRange || "0";
      selectedMax.value = storeData.value.propertyFilters.priceMaxRange || "0";
      ...
      let minPriceTitle = getPriceRangeDataTitle(priceRanges.value, storeData.value.propertyFilters.priceMinRange);
      let maxTitle = getPriceRangeDataTitle(priceRanges.value, storeData.value.propertyFilters.priceMaxRange);
