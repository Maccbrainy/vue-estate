        ...
        >
          ...
          >
            <div class="flex flex-row">
              <div class="w-9/12 flex flex-col xxs:px-2 px-4">
              ...
              <div class="w-3/12 flex flex-col">
                <span v-if="propertyHistory.price" class="w-auto px-4 font-semibold text-gray-700">
                  {{ `Price: $${addCommaToNumberFormat(propertyHistory.price)}` }}
                </span>
                <span class="w-auto py-2 px-4 xxs:hidden">
