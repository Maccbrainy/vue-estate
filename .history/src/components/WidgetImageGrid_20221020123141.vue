<template>
  <div class="flex relative overflow-hidden justify-center">
    <div class="relative w-full lm:w-9/12 min-w-max mx-auto cursor-pointer">
      <div class="grid grid-cols-4 grid-rows-2 gap-4 transform hover:scale-105">
      <widget-save-share class="absolute right-4 top-2 z-20"></widget-save-share>
        <div
          v-bind:class="{
