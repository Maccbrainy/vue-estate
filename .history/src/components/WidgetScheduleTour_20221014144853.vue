<template>
  <div class="py-3 border rounded-lg bg-gray-100 w-full">
    <ul class="w-full flex justify-around text-base font-medium text-gray-700 ">
      <li v-for="title in ['In-Person', 'Video Chat']" :key="title">
        <button
          :id="title"
          type="button"
          class="w-full border rounded-lg text-base font-medium text-gray-700 px-5 py-2"
        >
          {{ title }}
        </button>
      </li>
