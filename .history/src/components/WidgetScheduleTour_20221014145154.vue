<template>
  <div class="my-3 border rounded-lg w-full">
    <ul class="flex justify-around text-base font-medium text-gray-700">
      <li v-for="title in ['In-Person', 'Video Chat']" :key="title">
        <button
          :id="title"
          type="button"
          class="w-full block border rounded-lg text-base font-medium text-gray-700 px-5 py-2"
        >
          {{ title }}
        </button>
      </li>
