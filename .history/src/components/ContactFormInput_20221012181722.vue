  ...
  <div class="pt-4">
    ...
    >
      <label 
        ...
        v-bind:class="{ 'bg-white w-full': isTextAreaType || isSelectType }"
        class="
          absolute
          w-full
          left-4
      ...
      <select
        ...
        class="outline-none w-full h-full bg-transparent py-5 px-4 font-semibold text-gray-600"
      >
        <option 
          v-for="hour in selectOptions" 
...
export default {
  ...
  setup(props, context) {
    ...
    watchEffect(() => {
      ...
      console.log(`Model Values ${count++}`, props.dataValue);
    });
    return {
      focused,
      focusedCount,
