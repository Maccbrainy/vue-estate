...
export async function useFetch(
  ...
  // let propType = propertyType.value.length > 0 ? propertyType.join() : "";
  console.log("THIS IS THE PROPTYPE:", propertyType);
  ...
  // let propFeatures = homeFeatures.length > 0 ? homeFeatures.join() : "";
