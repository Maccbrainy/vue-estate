...
export async function useFetch(
  ...
  let sortingType = sortType || "relevance";
  let propType = !propertyType
    ? ""
    : propertyType.length > 0 
    ? propertyType.join() 
    : "";
  let priceMinParam = priceMin || "";
  let priceMaxParam = priceMax || "";
  let bedParam = bedsMin || "";
  let bathParam = bathNumber || "";
  ...
  try {
    ...
    console.log("Error in fetching from rapid api:", err, err.value); 
  } 
