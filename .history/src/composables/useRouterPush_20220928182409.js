...
export default function useRouterPush(payLoad) {
  ...
  router.beforeEach(() => {
    console.log("MACBRAINY BULL EYE");
 });
  ...
  let bedFilter = 
    searchParams.value.bed || storeData.value.propertyFilters.numberOfBed || "";
  ...
  console.log("CHECKING WHAT THIS istCITY:", city);
  console.log("CHECKING WHAT THIS 2ndtCITY:", cityParam);
  console.log("CHECKING WHAT THIS slug:", slugParam);

  console.log("USEROUTERPUSH RAN === AND USING ROUTE:", activeRoute.value);
  console.log("USEROUTERPUSH RAN bedFilter:", bedFilter);
  return {
