...
export default function useRouterPush(payLoad) {
  ...
  let bedFilter = storeData.value.propertyFilters.numberOfBed || "";
  ...
  router.beforeEach((to, from) => {
    fromROuter = from.name;
    toROuter = to.name;
    console.log("INSIDE ROUTERPUSH to:", to.name);
  })
  console.log("USEROUTERPUSH RAN === AND USING ROUTE:", activeRoute.value);
  console.log("USEROUTERPUSH RAN === AND USING FROMROUTE:", fromROuter);
  console.log("USEROUTERPUSH RAN === AND USING TOROUTE:", toROuter);
