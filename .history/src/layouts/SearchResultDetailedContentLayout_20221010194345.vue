...
export default {
  ...
  setup(props) {
    ...
    const moveSlide = (direction) => {
      ...
      // showHideButtonRight.value = (-(moveSlideDirectionIndex.value) > contentWidthTheVisibleArea) ? true : false;
      showHideButtonRight.value = (overAllScrollWidthLength)(moveSlideDirectionIndex.value) > contentWidthTheVisibleArea ? true : false;

      console.log("showHideButtonLeft:", showHideButtonLeft);
      ...
      console.log("RemainderScrollWidth:", (overAllScrollWidthLength)(moveSlideDirectionIndex.value));
    };
