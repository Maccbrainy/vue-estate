    ...
    >
      <div class="w-9/12 mx-auto px-4">
        ...
        <div
          ...
          "
        >
          <widget-request-info-form></widget-request-info-form>
        </div>
      </div>
    </div>
              ...
              <div class="block w-full">
                ...
                >
                  ...
                  <div class="flex flex-col">
                    <ul class="flex flex-row justify-between text-gray-600 text-base">
                      <li class="font-semibold">Sunday, October 16</li>
                      <li>12:30 PM to 1:30 PM</li>
                      <li>==||==</li>
                    </ul>
                  </div>
                </div>
      ...
      >
        ...
        >
          <div class="w-11/12 m-auto pt-2">
            ...
            <widget-contact-form v-if="propertyDetail[0].lead_forms.form.show"></widget-contact-form>
            <widget-schedule-tour v-else></widget-schedule-tour>
            </div>
          </div>
        </div>
      </div>
