    ...
    >
      <div class="w-5/12 h-5/6
        ...
        <div class="
            ...
            px-5
            py-1">
            <div class="text-gray-500 font-Semibold text-lg py-1">Schedule A Tour</div>
            <widget-schedule-tour 
              v-bind:propertyName="fullPropertyAddressIdentity"> 
             </widget-schedule-tour>
          </div>
          <close-mobile-menu
            class="absolute right-5 border rounded-full top-5 hover:text-teal hover:shadow-lg text-gray-600"
