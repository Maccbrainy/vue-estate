<template>
  <div
    class="w-full relative -bottom-16 top-16 bg-white overflow-x-hidden min-h-screen"
  >
    <div
    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div id="#ListingProviderModule" class="absolute my-6">
      ...
      <div id="#propertyDescriptionModule" class="relative my-4">
        <p class="text-xs text-gray-500 font-normal text-justify">
          {{`${propertyAddress}, ${propertyCity}, ${slug} ${postalCode} is a ${bedProperty == 0 ? 'Studio,' : `${bedProperty} bedroom,`} ${bathProperty > 0 ? `${bedProperty} bathroom,` : ""} ${propertySqft != null ? `${propertySqft} sqft,` : ""} .`}}
        </p>
      </div>
    </div>
  </div>
