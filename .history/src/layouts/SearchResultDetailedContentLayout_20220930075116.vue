  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div id="#homePriceHistory" class="relative my-8 flex flex-col">
        ...
        <span v-show="propertyDetail[0].property_history.length > 4 && !toggleTable" class="bg-gradient-to-t from-white h-10 w-full -mt-12"> </span>
        <button
          v-show="propertyDetail[0].property_history.length > 4"
...
export default {
  ...
  setup(props) {
    ...
    const propertyHistories = computed(() => {
      return toggleTable.value ? propertyDetail.value[0].property_history : propertyHistoriesToShowAtDefault.value
    })
