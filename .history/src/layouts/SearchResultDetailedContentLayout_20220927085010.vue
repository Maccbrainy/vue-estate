<template>
  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
              ...
              <div class="block w-full">
                ...
                <div id="#descriptionModule" class="relative my-6">
                  ...
                  <p 
                    ...
                    class="text-gray-700 text-base pb-4">
                    {{ descriptionContentToShowAtToggle }}
                  </p>
                  <span
                    v-if="descript.length > 595"
                    v-on:click="toggleDescription = !toggleDescription"
                    v-bind:class="{
                      'hidden': toggleDescription
                    }"
                    class="
                      px-4
                      py-2
      ...
      <div id="#HighlightModule" class="w-full border rounded-lg h-40">
        <div class="text-gray-700 font-bold text-xl px-5 pt-5">
          Home Highlights
        </div>
        <div class="flex mt-1">
          <div class="w-1/2 px-5 text-gray-600 text-base">
...
import { ArrowBackIcon, ChevronRight, DollarIcon } from "@/assets/icons";
...
export default {
  ...
  setup(props) {
    ...
    const descriptionContentToShowAtDefault = computed(() => {
      let description;
      if (descript.value.length > 595){
        description = descript.value.slice(0, 595);
      }
      if (descript.value.length <= 595){
    ...
    watchEffect(() => {
      console.log("Toggle Description:", toggleDescription.value)
    })
    const descriptionContentToShowAtToggle = computed(() =>
      descript.value.slice(595)
    );
