    ...
    <div class="w-9/12 mx-auto px-4">
      <div class="flex flex-wrap">
        ...
        <div class="w-4/12 border mt-8 rounded-lg h-auto">
          <div class="block text-center text-gray-600 text-base p-6">
            <h2>Request for tour as early as</h2>
            <p class="font-bold">Today at 2:30pm</p>
          </div>
          <button type="button" class="border border-red-500 bg-red-500 font-bold text-base text-white hover:bg-transparent">Shedule a tour</button>
          <button type="button" class="border border-teal font-bold text-base text-white hover:bg-teal-lighter">Shedule a tour</button>
        </div>
      </div>
    </div>
  </div>
