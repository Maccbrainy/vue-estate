            ...
            <div class="contact-form text-gray-700">
              ...
              <div>
                <div
                  ...
                  <label v-show="focused || getContactValues" class="absolute text-gray-400 left-4 font-semibold text-xs text-gray-700 z-10 pt-px">Name</label>
                  <input
              ...
              <div class="pb-4">
                <div
                  ...
                  class="relative border border-gray-500 rounded-lg h-auto overflow-hidden">
                  <label v-show="focused || getContactValues" class="absolute text-gray-400 left-4 font-semibold text-xs text-gray-700 z-10 pt-px">Phone</label>
                  <input
                    v-model="getContactValues"
                    v-on:focus="focused = true"
                    v-on:blur="focused = false"
