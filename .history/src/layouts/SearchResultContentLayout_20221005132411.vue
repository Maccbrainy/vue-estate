<template>
  <filter-button-container :key="$route.fullPath"></filter-button-container>
  ...
  setup(props) {
    ...
    watchEffect(() => {
      ...
      if (
        ...
        updateRouterParams.openHouses = props.hasOpenHouses || "";
        updateRouterParams.newConstruction = props.newConstruction || "";
