        ...
        <div id="#contactModule" class="w-4/12 mt-8 max-h-96 relative">
          <div
            ...
            >
              ...
              >
              index move {{moveSlideDirectionIndex}}
                <button
                  v-show="getMoveSlideDirectionIndex > 0"
...
export default {
  ...
  setup(props) {
    ...
    const getMoveSlideDirectionIndex = computed(() => moveSlideDirectionIndex.value);
