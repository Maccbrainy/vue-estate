...
import { useIsTrueIfPropertyExist } from "@/composables";
...
export default {
  ...
  setup(props) {
    ...
    watchEffect(async () => {
      ...
      bedProperty.value = useIsTrueIfPropertyExist(
        propertyDetail.value[0],
        "beds"
      );
      bedPropertyMin.value = useIsTrueIfPropertyExist(
        propertyDetail.value[0],
        "community",
        "beds_min"
      );
      bedPropertyMax.value = useIsTrueIfPropertyExist(
        propertyDetail.value[0],
        "community",
        "beds_max"
      );
      bathProperty.value = useIsTrueIfPropertyExist(
        propertyDetail.value[0],
        "baths"
      );
      bathPropertyMin.value = useIsTrueIfPropertyExist(
        propertyDetail.value[0],
        "community",
        "baths_min"
      );
      bathPropertyMax.value = useIsTrueIfPropertyExist(
        propertyDetail.value[0],
        "community",
        "baths_max"
      );
      let propertySquareFeet = useIsTrueIfPropertyExist(
        propertyDetail.value[0],
        "building_size",
        "size"
      );
