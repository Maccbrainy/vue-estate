        ...
        <div id="#contactModule" class="w-4/12 mt-8 max-h-96 relative">
          <div
            ...
            <div class="contact-form text-gray-700">
              ...
              <div
                v-bind:class="{
                  'focus:outline-none focus:ring focus:ring-offset-2 focus:ring-offset-white focus:ring-teal-light':
                    focused,
                }"
                class="border border-gray-500 py-4 rounded-lg px-1 overflow-hidden">
                {{focused}}
                <input 
                  ...
                  focus:ring-teal-light transform translate-y-2" />
              </div>
            </div>
