  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
      <div class="flex flex-wrap">
              ...
              <div class="block w-full">
                <div id="#localInformationModule" class="relative my-6">
                  ...
                  <div>
                    ...
                    <div class="w-full h-56 rounded-lg bg-gray-200 mt-4 border-solid border-transparent border-r-8">
        ...
        <div class="w-4/12 border mt-8 rounded-lg max-h-80 overflow-auto">
