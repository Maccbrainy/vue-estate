              ...
              <div class="block w-full">
                ...
                <div id="#descriptionModule" class="relative my-6">
                  ...
                  <p class="text-gray-700 text-base pb-4">
                    ...
                    {{descript.split(" ").length}}:{{ propertyDetail[0].description }}
                  </p>
                  <button type="button" class="px-4 py-2 text-gray-600 font-bold text-base border border-gray-800 rounded-lg bg-white">See More</button>
                </div>
