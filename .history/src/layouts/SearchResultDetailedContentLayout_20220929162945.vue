  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div id="#homePriceHistory" class="relative my-6">
        ...
        <div class="w-full max-h-96 border border-gray-800 rounded-lg">
          <div 
            class="flex justify-between p-2 text-gray-600 font-bold bg-gray-200">
            <div class="px-5 py-1">Date</div>
            <div class="px-5 py-1">Price</div>
            <div class="px-5 py-1">Event</div>
            <div class="px-5 py-1">Source</div>
          </div>
        </div>
      </div>
    </div>
