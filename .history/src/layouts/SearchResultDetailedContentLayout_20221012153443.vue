...
import { addCommaToNumberFormat, removeUnderScoresFromAString, setWorkingHoursRangeInADate } from "@/helper";
...
export default {
  ...
  setup(props) {
    ...
    const isTodaysDate = ref(new Date());
    ...
    const getDateAndTime = (_, date, index) => {
      ...
      let workingHoursOtherDays = setWorkingHoursRangeInADate(date.rawDate);
      console.log("OtherDays working hours", workingHoursOtherDays);
      // const isFutureDateStartTime = new Date(date.rawDate.setHours(9,0,0,0));
      // const isPresentDateStartTime = new Date(new Date().setHours(11,0,0,0)); 

      // const timesOfTheDay = [];
      // const startDayTime = isFuture(date.rawDate) ? isFutureDateStartTime : isPresentDateStartTime;
    ...
    watchEffect(() => {
      ...
      console.log("Get Working Hours Today", setWorkingHoursRangeInADate(isTodaysDate.value));
