      ...
      <div id="#homePriceHistory" class="relative my-6">
        ...
        <div class="w-full max-h-96 border rounded-lg">
          <div class="grid grid-col-4 grid-rows-4">
            <div class="col-span-1 row-span-1">Date</div>
            <div class="col-span-1 row-span-1">Price</div>
            <div class="col-span-1 row-span-1">Event</div>
            <div class="col-span-1 row-span-1">Source</div>
          </div>
        </div>
      </div>
    </div>
