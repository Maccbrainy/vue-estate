  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div id="#homePriceHistory" class="relative my-8 flex flex-col">
        <div class="text-gray-700 font-bold text-xl my-4">
          Property History for {{ propertyAddress }}
        </div>
        <table class="table-fixed bg-gray-100  w-full h-auto overflow-hidden text-gray-600 rounded-tl-lg rounded-tr-lg rounded-br-lg rounded-bl-lg">
          <thead>
            <tr class="w-full py-3 text-gray-600">
              <th class="w-1/5 text-left py-2 px-4">Date</th>
              <th class="w-1/5 text-left py-2 px-4">Price</th>
              <th class="w-1/5 text-left py-2 px-4">Sqft</th>
              <th class="w-1/5 text-left py-2 px-4">Event</th>
              <th class="w-1/5 text-left py-2 px-4">Source</th>
            </tr>
          </thead>
          <tbody class="bg-white">
            <tr 
              class="border" 
              v-for="propertyHistory in propertyDetail[0].property_history" 
              :key="propertyHistory.date">
              <td class="w-auto py-2 px-4 border-t">{{propertyHistory.date}}</td>
              <td class="w-auto py-2 px-4 border-t">{{propertyHistory.price}}</td>
              <td class="w-auto py-2 px-4 border-t">{{propertyHistory.sqft}}</td>
              <td class="w-auto py-2 px-4 border-t">{{propertyHistory.event_name}}</td>
              <td class="w-auto py-2 px-4 border-t flex justify-between">
                <span>{{propertyHistory.source}}</span>
                <button v-show="propertyHistory.event_name == `Sold`" v-on:click="openRecord = !openRecord">
                   <chevron-down :class="{'transform rotate-180': openRecord}" 
                  class=" text-gray-600 bg-white border rounded-full hover:shadow-md active:bg-gray-300"/>
                </button>
              </td>
            </tr>
            <tr v-show="openRecord" class="w-full bg-gray-100 py-3 text-gray-600 border">
              <td class="w-auto py-2 px-3" colspan="5">
                <div class="flex flex-wrap">
                  <div class="w-1/5 flex-initial block border-solid border-transparent border-t-4 border-b-0 border-r-8 border-l-8">
                    <dt class="block font-bold text-gray-600">Recording Date</dt>
                    <dd class="block font-normal">N/A</dd>
                  </div>
                  <div class="w-1/5 flex-initial block border-solid border-transparent border-t-4 border-b-0 border-r-8 border-l-8">
                    <dt class="block font-bold text-gray-600">County Transfer Tax</dt>
                    <dd class="block font-normal">N/A</dd>
                  </div>
                  <div class="w-1/5 flex-initial block border-solid border-transparent border-t-4 border-b-0 border-r-8 border-l-8">
                    <dt class="block font-bold text-gray-600">Total Transfer Tax</dt>
                    <dd class="block font-normal">N/A</dd>
                  </div>
                </div>
              </td>
            ...
            <tr class="border">
              <td class="w-auto py-2 px-4 border-t">22 Feb 2020</td>
              <td class="w-auto py-2 px-4 border-t">$2,000,000</td>
              <td class="w-auto py-2 px-4 border-t">47000</td>
              <td class="w-auto py-2 px-4 border-t">Listed</td>
              <td class="w-auto py-2 px-4 border-t">MLS#12356</td>
            </tr>
            <tr class="border">
              <td class="w-auto py-2 px-4 border-t">22 Feb 2020</td>
              <td class="w-auto py-2 px-4 border-t">$2,000,000</td>
              <td class="w-auto py-2 px-4 border-t">4000</td>
              <td class="w-auto py-2 px-4 border-t">Price Changed</td>
              <td class="w-auto py-2 px-4 border-t">MLS #448231</td>
            </tr>
          </tbody>
        </table>
      </div>
