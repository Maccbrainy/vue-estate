<template>
  ...
  >
    ...
    <div v-if="propertyDetail.length > 0" class="mf:hidden lm:w-9/12 mx-auto py-2 flex items-center font-normal">
      <button
        @click="$router.go(-1)"
    ...
    <div class="w-9/12 mx-auto px-4">
      <div class="flex flex-wrap">
            ...
            <div class="flex flex-wrap">
              <div class="w-8/12">
                ...
                <widget-utility-summary
                  v-bind:fetchingIsBusy="isLoading"
                  v-bind:bedroom="bed"
                  v-bind:bedroomMin="bedMin"
                  v-bind:bedroomMax="bedMax"
                  v-bind:bathroom="bath"
                  v-bind:bathroomMin="bathMin"
                  v-bind:bathroomMax="bathMax"
                  v-bind:squarefoot="sqft"
                  class="my-3"
                >
                </widget-utility-summary>
              </div>
              <div class="w-4/12">
                ...
                >
                  <div v-show="price">
                    ...
                    <div v-show="mortgageMonthlyPayment">
                      <div class="text-gray-700">
                        Est. Mortgage
                        {{ mortgageMonthlyPayment }}/mo*
                      </div>
                      <div class="flex underline text-teal text-base font-bold">
                        <span><dollar-icon /></span>
                        <a
                          class="px-2"
                          v-bind:href="mortgageRateUrl"
                          target="__blank"
                          >Get Pre-Qualified</a
                        >
                      </div>
        ...
        <div id="#contactModule" class="w-4/12 mt-8 max-h-96 relative">
          ...
          >
            ...
            <div id="#RequestForTourModule" class="text-center" v-else>
      ...
      <widget-history-table
        ...
        v-bind:propertyContentData="priceHistory"
      >
      </widget-history-table>
      <widget-history-table
        ...
        v-bind:propertyContentData="taxHistory"
      >
      </widget-history-table>
...
import { ref, watchEffect, computed, onMounted, onUnmounted, provide, toRefs } from "vue";
