  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
            ...
            <div class="flex flex-wrap">
              ...
              <div class="w-3/12">
                ...
                <div v-show="propertyPrice && !isLoading">
                  ...
                  <div>Est. Mortgage {{propertyDetail[0].mortgage.estimate.monthly_payment}}/mo*</div>
                </div>
                </div>
              </div>
      ...
      <div id="#homeDetailModule" class="relative my-6">
        <div class="text-gray-700 font-bold text-xl my-4">Home Detail for {{propertyAddress}}</div>
      </div>
    </div>
  </div>
</template>
