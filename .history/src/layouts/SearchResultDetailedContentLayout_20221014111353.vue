<template>
  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div id="#contactAnAgent" class="relative my-6">
        ...
        <div class="relative">
          ...
          >
            <li
              v-for="(title, index) in ['Schedule A Tour', 'Request Info']"
              :key="title"
            >
              <button
                v-on:click="getMappingIdForContent"
                :id="title"
                v-bind:class="{
                  'border border-b-0 border-r-0 rounded-t-lg bg-white z-10':
                    index == 0,
                  'border rounded-bl-lg border-t-0 border-r-0 border-b-0 border-r-0 rounded-t-lg bg-white z-10':
                    index == 1,
                  'border rounded-bl-lg': activeMappingTable = title,
                }"
                type="button"
                class="
                  text-lg
          ...
          <div class="block w-full h-56 border rounded-bl-lg rounded-r-lg transform translate-y-11">
            <span class="p-4">{{ renderMappingContent }}</span>
          </div>
        </div>
      </div>
