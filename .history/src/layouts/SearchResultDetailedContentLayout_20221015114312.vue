        ...
        <div id="#contactModule" class="w-4/12 mt-8 max-h-96 relative">
          ...
          >
            ...
            <div id="#RequestForTourModule" class="text-center">
              ...
              <button
                v-on:click="isModalOpen = !isModelOpen"
                type="button"
                class="
                  w-full
    ...
    >
      <div class="w-5/12 h-5/6
        ...
        <div class="
            ...
            px-5
            py-1">
            <div class="text-gray-700 font-bold text-lg py-1">Schedule A Tour</div>
            <widget-schedule-tour 
              v-bind:propertyName="fullPropertyAddressIdentity"> 
             </widget-schedule-tour>
          </div>
          <close-mobile-menu
            class="absolute right-5 border bg-white rounded-full top-5 hover:border-transparent hover:text-teal hover:shadow-xl text-gray-600"
