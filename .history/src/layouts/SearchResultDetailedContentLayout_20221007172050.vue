          ...
          <div
            ...
            <div class="contact-form text-gray-700">
              ...
              <div
                ...
                <label v-show="focused || getContactValues" class="absolute text-gray-400 left-4 font-semibold text-xs text-gray-700 z-10 py-1">Name</label>
                <input
                  ...
                  type="text"
                  name="name"
                  :class="{'transform translate-y-2': focused || getContactValues}"
