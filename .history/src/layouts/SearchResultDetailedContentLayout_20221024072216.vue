<template>
  ...
  >
    ...
    <div v-if="propertyDetail.length > 0" class="mf:hidden w-full lm:max-w-5xl mx-auto py-2 flex items-center font-normal">
      <router-link
        :to="historyRoutePath"
      ...
      <div class="flex justify-between flex-wrap">
        ...
        >
          <div class="flex flex-col my-3">
            <div class="flex flex-wrap sf:flex-col">
              <div class="w-8/12">
                <div>
        ...
        <div class="relative">
          ...
          >
            <div v-if="renderIsScheduleFormType">
              <div class="sf:w-11/12 md:flex md:flex-initial md:gap-16 items-center">
                <schedule-tour-icon class="min-w-max h-auto sf:hidden" />
                <div>
                  <widget-schedule-tour 
                    v-bind:propertyName="fullPropertyAddressIdentity"> 
                  </widget-schedule-tour>
