  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
      <div class="flex flex-wrap">
                  ...
                  <div>
                    ...
                    <div
                      ...
                      block
                        ...
                        bg-gray-200
                        mt-4
                        border-solid border-transparent border-r-8
                      "
                    >
        ...
        <div class="w-4/12 mt-8 max-h-80 overflow-auto">
          <div class="block w-11/12 border rounded-lg m-auto text-center text-gray-600 text-base p-6">
