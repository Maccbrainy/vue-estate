          ...
          <div class="w-1/2 px-5 text-gray-600 text-base">
            <div class="w-9/12">
              <div class="flex justify-between py-1">
                <span class="inline-flex"><parking-icon /><span class="px-5">Parking</span></span>
...
import { ArrowBackIcon, ChevronRight, DollarIcon, ParkingIcon } from "@/assets/icons";
  ...
  setup(props) {
    ...
    const descriptionContentToShowAtDefault = computed(() => {
      ...
      if (descript.value.length > descriptionCountMaximum.value) {
        description = descript.value.slice(0, descriptionCountMaximum.value).concat(`...`);
      }
      if (descript.value.length <= descriptionCountMaximum.value) {
