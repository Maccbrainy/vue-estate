<template>
  <div
    class="w-full relative -bottom-16 pb-20 bg-white overflow-x-hidden min-h-screen"
  >
    <div
    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div v-if="propertyDetail.length > 0" id="#ListingProviderModule" class="relative my-6 -bottom-12">
      ...
      <div id="#propertyDescriptionModule" class="relative my-4 -bottom-12">
