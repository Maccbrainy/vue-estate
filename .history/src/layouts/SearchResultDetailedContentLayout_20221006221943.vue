<template>
  ...
  >
    ...
    >
      <div class="lm:w-9/12 flex">
        <div class="block">
          <span class="text-base font-semibold text-gray-700">{{propertyAddress}}</span>
          <span>{{ `${propertyCity}, ${slug}  ${postalCode}` }}</span>
        </div>
        <div class="text-base font-semibold text-gray-700">{{propertyPrice}}</div>
        <div></div>
      </div>
    </div>
