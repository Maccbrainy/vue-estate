...
export default {
  ...
  setup(props) {
    ...
    const getDateContainerWidthRef = () => {
      ...
      console.log("GetclientWidthContent:", dateContentWidthRef.value.clientWidth);
      console.log("GetoffsetWidthContent:", dateContentWidthRef.value.offsetWidth);
    };
    ...
    // function getDateContainerWidthRef(){
    //   console.log("GetContainer:", dateContainerWidthRef.value); 
    //   // console.log("GetContaineroffsetWidth:", dateContainerWidthRef.value.offsetWidth); 
    //   // return dateContainerWidthRef.value.clientWidth; 
    // };
