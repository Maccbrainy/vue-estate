    ...
    >
      ...
      >
        <div class="bg-white z-10">
          <div
            class="fixed flex justify-between w-full items-center border-b px-4 pt-2 pb-3"
          >
            <ul
              class="
                flex
          ...
          />
          <div class="sticky text-gray-700 text-base font-semibold px-4 py-1">
            <div>
              {{
        ...
        <div class="relative w-8/12 top-24">
