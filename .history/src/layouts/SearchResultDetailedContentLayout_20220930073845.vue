  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
            ...
            <div class="flex flex-wrap">
              ...
              <div class="block w-full">
                ...
                <div id="#descriptionModule" class="relative my-6">
                  ...
                  <span
                    v-show="descript.length > descriptionCountMaximum && !toggleDescription"
                    class="
                      absolute
                      bg-gradient-to-t
                      from-white
      ...
      <div id="#homePriceHistory" class="relative my-8 flex flex-col">
          ...
          <tbody class="bg-white">
            ...
            >
              <td class="w-auto py-2 px-4">
                {{ propertyHistory.date }}
              </td>
              <td class="w-auto py-2 px-4">${{ propertyHistory.price }}</td>
              <td class="w-auto py-2 px-4">
        ...
        <span v-show="propertyDetail.value[0].property_history.length > 4 && !toggleTable" class="bg-gradient-to-t from-black h-10 w-full -mt-12"> </span>
        <button
          v-show="propertyDetail.value[0].property_history.length > 4"
...
export default {
  ...
  setup(props) {
    ...
    const propertyHistoriesToShowAtDefault = computed(() => {
      let historyData;
      if (propertyDetail.value[0].property_history.length > 4) {
        historyData = propertyDetail.value[0].property_history.filter((data, index) => index < 4 ? data : "");
      }
      if (propertyDetail.value[0].property_history.length <= 4) {
        historyData = propertyDetail.value[0].property_history;
      }
      console.log("History:", historyData);
      return historyData;
    });
    const propertyHistories = computed(() => {
      return toggleTable ? propertyDetail.value[0].property_history : propertyHistoriesToShowAtDefault.value
    })
    ...
    return {
      ...
      descriptionContentToShowAtDefault,
      propertyHistories,
      propertyHistoriesToShowAtDefault,
