      ...
      >
        ...
        <div class="relative w-8/12">
          <div class="text-gray-700 text-base font-semibold px-4 py-1">
            <div>{{`${propertyAddress} | $${propertyPrice} | ${bedProperty == 0 ? 'Studio': bedProperty > 0 ? bedProperty : ''} ${bathProperty > 0 ? bathProperty : ''}`}}</div>
          </div>
          <div class="block w-full h-96 rounded-lg bg-gray-200 mt-4">
            <span class="p-4">{{ renderMappingContent }}</span>
          </div>
        </div>
