          ...
          <div
            ...
            <div class="contact-form text-gray-700">
              ...
              <div
                ...
                class="relative border border-gray-500 rounded-lg py-1">
                <label v-show="focused || getContactValues" class="absolute text-gray-400 left-4 font-semibold text-xs text-gray-700">Name</label>
                <input
              ...
              <div 
                v-show="!focused && focusedCount > 0 && getContactValues.length > 4" 
