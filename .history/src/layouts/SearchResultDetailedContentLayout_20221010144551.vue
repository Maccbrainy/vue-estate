          ...
          <div
            ...
            >
              ...
              <div 
                ...
                class="overflow-hidden relative outline outline-teal-light"
              >
                <button
                  v-on:click="moveSlide()"
                  class="absolute z-10 -left-0.5 top-1/2">
                  <chevron-left 
                    class="
                      text-gray-800
                      w-5
                ...
                <button
                  class="absolute z-10 -right-0.5 top-1/2">
                  <chevron-right 
                    v-on:click="moveSlide()" 
                    class="
                      text-gray-800 
