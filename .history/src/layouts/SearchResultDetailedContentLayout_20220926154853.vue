                ...
                <div class="my-6 text-gray-700">
                  ...
                  <div>
                    <ul
                      ...
                      "
                    >
                      <li><button type="button" class="rounded-md hover:bg-gray-200 px-4 py-2">Map</button></li>
                      <li><button type="button" class="rounded-md hover:bg-gray-200 px-4 py-2">Schools</button></li>
                      <li><button type="button" class="rounded-md hover:bg-gray-200 px-4 py-2">Shop & Eat</button></li>
                    </ul>
                  </div>
                </div>
                <div>
