<template>
  ...
  <div class="flex flex-grow flex-auto flex-col z-0">
    <div
      v-bind:class="{
...
<script>
import { ref, computed, watchEffect, onMounted, onBeforeUnmount, provide } from "vue";
...
export default {
  ...
  setup(props) {
    ...
    provide("activePropertyListings", activePropertyListings.value);
