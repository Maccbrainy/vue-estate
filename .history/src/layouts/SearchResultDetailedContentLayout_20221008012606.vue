    ...
    >
      ...
      >
        ...
        <div class="flex">
          ...
          <div class="relative w-4/12 h-full top-24 overflow-y-auto">
            <div class="w-full border rounded-lg bg-white shadow-xl px-4">
              <h2 class="font-bold text-base text-gray-700">Contact This Property</h2>
              <widget-contact-form></widget-contact-form>
            </div>
        </div>
        </div>
