  ...
  setup(props) {
    ...
    const activeFilterDescriptionEnteries = computed(() => {
      ...
      let filterEntries = {
        ...
        petFriendly: storeData.value.propertyFilters.allowsDogs && storeData.value.propertyFilters.allowsDogs ? "Cats and Dogs" : storeData.value.propertyFilters.allowsDogs ? "Dogs allowed" : "Cats allowed",
