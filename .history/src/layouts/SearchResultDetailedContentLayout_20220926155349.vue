          ...
          <div class="flex flex-col my-3">
            <div class="flex flex-wrap">
              <div class="w-8/12">
                ...
                <div class="my-6">
                  <div class="text-gray-700 font-bold text-xl">Local Information</div>
                  <div>
                    <ul
                      class="
                        flex
                      ...
                      "
                    >
                      <li><button type="button" class="rounded-md text-base font-medium text-gray-700 hover:bg-gray-200 px-4 py-2">Map</button></li>
                      <li><button type="button" class="rounded-md text-base font-medium text-gray-700 hover:bg-gray-200 px-4 py-2">Schools</button></li>
                      <li><button type="button" class="rounded-md text-base font-medium text-gray-700 hover:bg-gray-200 px-4 py-2">Shop & Eat</button></li>
                    </ul>
                  </div>
                </div>
                <div>
                  <div class="text-gray-700 font-bold text-xl">Description</div>
                </div>
              </div>
              <div class="w-3/12">
                <div
