<template>
  ...
  <teleport v-if="isMediaTable" to="body">
    <section class="fixed w-full h-screen bg-black opacity-60 top-0 right-0 left-0 z-30">
      <div class="w-11/12 h-5/6 bg-white mx-auto my-auto relative">
        <div class="w-9/12 flex justify-between bg-white">
          <div>Media Photo</div>
          <div>Map</div>
          <div>Schools</div>
