          ...
          <div
            ...
            >
              ...
              index move right: {{showHideButtonRight}}
                ...
                <button
                  v-show="moveSlideDirectionIndex > 0"
...
export default {
  ...
  setup(props) {
    ...
    const showHideButtonRight = ref(0);
