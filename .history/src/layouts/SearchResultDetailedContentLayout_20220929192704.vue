  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div id="#homePriceHistory" class="relative my-8 flex flex-col">
        ...
        <table class="table-fixed w-full h-auto border text-gray-600">
          <thead>
            <tr class="w-full bg-gray-100 py-3 text-gray-600">
              <th class="w-3/12 text-left py-2 px-4">Date</th>
              <th class="w-3/12 text-left py-2 px-4">Price</th>
              <th class="w-3/12 text-left py-2 px-4">Sqft</th>
              <th class="w-3/12 text-left py-2 px-4">Event</th>
              <th class="w-3/12 text-left py-2 px-4">Source</th>
            </tr>
          </thead>
          <tbody>
            <tr>
            ...
            <tr class="w-full bg-gray-100 py-3 text-gray-600">
              <td class="w-auto py-2 px-3" colspan="4">
                <div class="flex flex-wrap">
                  <div class="w-3/12 flex-initial block border-solid border-transparent border-t-4 border-b-0 border-r-8 border-l-8">
            ...
            <tr>
              ...
              <td class="w-auto py-2 px-4 border-t">Public Record/MLS#12356</td>
            </tr>
            <tr>
              <td class="w-auto py-2 px-4 border-t">22 Feb 2020</td>
              <td class="w-auto py-2 px-4 border-t">$2,000,000</td>
