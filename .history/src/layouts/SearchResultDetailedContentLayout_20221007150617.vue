          ...
          <div
            ...
            <div class="contact-form text-gray-700">
              ...
              <div
                ...
                <label v-bind:class="{
                   'transform translate-y-2/4 text-base text-gray-400': !focused && !getContactValues,
                   'font-semibold text-xs': focused,
                   'font-semibold text-xs': getContactValues,
                  }" class="absolute left-4">Name</label>
                <input
