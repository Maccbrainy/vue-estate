            ...
            >
              ...
              <div 
                ...
                <ul
                  ...
                  class="overflow-hidden flex flex-row gap-2 flex-nowrap py-2">
                  <li
                ...
                <dropdown-button-select-box>
                  <dropdown-button-select
                    v-model="selectTime"  
                    class="px-0 border ring-offset-1 text-gray-600 font-semibold">
                    <dropdown-button-select-option 
                      v-for="hour in getDateWorkingHours" 
                      v-bind:key="hour.date"
                      v-bind:value="hour.time">
                      {{ hour.time }}
                    </dropdown-button-select-option>
                  </dropdown-button-select>
                </dropdown-button-select-box>
...
import { 
  ...
  setTheDaysInAWeekRange, 
  setWorkingHoursRangeInADate 
} from "@/helper";
import { 
