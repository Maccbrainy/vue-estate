    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div id="#homePriceHistory" class="relative my-6">
        ...
        <div class="w-full max-h-96 border rounded-lg">
          <div 
            class="flex justify-between p-2 text-gray-600 bg-gray-200 font-bold rounded-tl-lg rounded-tr-lg">
            <span class="px-3 py-1">Date</span>
            <span class="px-3 py-1">Price</span>
            <span class="px-3 py-1">Sqft</span>
            <span class="px-3 py-1">Event</span>
            <span class="px-3 py-1">Source</span>
          </div>
          <div class="flex justify-between text-center p-2 text-gray-600 border-t">
            <span class="pl-3 py-1">22 Feb 2020</span>
            <span class="-ml-2 py-1">$2,000,000</span>
            <span class="-ml-5 py-1">4000</span>
            <span class="-ml-2 py-1">Sold</span>
            <span class="pr-3 py-1">Public Record</span>
          </div>
          <div class="flex justify-between text-center p-2 text-gray-600 border-t">
            <span class="px-3 py-1">22 Feb 2020</span>
            <span class="px-3 py-1">$2,000,000</span>
            <span class="px-3 py-1">700</span>
            <span class="px-3 py-1">Sold</span>
            <span class="px-3 py-1">Public Record</span>
          </div>
          <div class="flex justify-between text-center p-2 text-gray-600 border-t">
            <span class="px-3 py-1">22 Feb 2020</span>
            <span class="px-3 py-1">$2,000,000</span>
            <span class="px-3 py-1">7700</span>
            <span class="px-3 py-1">Listed</span>
            <span class="px-3 py-1">MLS #11106166</span>
          </div>
        </div>
      </div>
    </div>
