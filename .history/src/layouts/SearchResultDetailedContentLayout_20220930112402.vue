                    ...
                    >
                      <li>
                        <button
                          ...
                          id="propertyMap"
                          v-bind:class="{'text-teal shadow-lg border hover:bg-white':activeMappingTable == `propertyMap`}"
                          type="button"
                          class="
                            rounded-md
                            text-base
                      ...
                      <li>
                        <button
                          ...
                          v-bind:class="{'text-teal shadow-lg border hover:bg-white':activeMappingTable == `propertySchoolMap`}"
                          type="button"
                          class="
                            rounded-md
                            text-base
                      ...
                      <li>
                        <button
                          ...
                          v-bind:class="{'text-teal shadow-lg border hover:bg-white':activeMappingTable == `propertyShop&EatMap`}"
                          type="button"
                          class="
                            rounded-md
                            text-base
