...
import { addCommaToNumberFormat, removeUnderScoresFromAString, setWorkingHoursOfADate } from "@/helper";
...
export default {
  ...
  setup(props) {
    ...
    const getDateAndTime = (_, date, index) => {
      ...
      let workingHoursOtherDays = setWorkingHoursOfADate(date.rawDate);
    ...
    watchEffect(() => {
      ...
      console.log("Get Working Hours Today", setWorkingHoursOfADate(isTodaysDate.value));
