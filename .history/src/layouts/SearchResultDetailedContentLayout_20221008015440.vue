  ...
  <teleport v-if="isMediaTable" to="body">
    ...
    >
      ...
      >
        ...
        <div class="relative float-right w-4/12 h-full top-28 overflow-y-auto transform translate-y-3/4">
          <div class="absolute right-0 top-0 w-10/12 border rounded-lg bg-white shadow-xl px-4 pt-2">
