      ...
      <div id="#homePriceHistory" class="relative my-8 flex flex-col">
        ...
        <table class="table-fixed w-full h-auto border text-gray-600">
          ...
          <tbody>
            ...
            <tr class="w-full bg-gray-100 py-3 text-gray-600">
              <td class="w-auto py-2 px-4" colspan="5">
                <div class="flex flex-wrap">
                  <div class="w-3/12 flex-initial block border-solid border-transparent border-t-8 border-b-0 border-r-8 border-l-8">
                    <dt class="block font-bold text-gray-800">Recording Date</dt>
