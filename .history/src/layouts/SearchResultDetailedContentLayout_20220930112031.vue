                    ...
                    >
                      <li>
                        <button
                          ...
                          id="propertyMap"
                          v-bind:class="{'text-teal shadow-lg border hover:bg-transparent':activeMappingTable == `propertyMap`}"
                          type="button"
                          class="
                            rounded-md
                            text-base
                      ...
                      <li>
                        <button
                          ...
                          v-bind:class="{'text-teal shadow-lg border hover:bg-transparent':activeMappingTable == `propertySchoolMap`}"
                          type="button"
                          class="
                            rounded-md
                            text-base
                      ...
                      <li>
                        <button
                          ...
                          v-bind:class="{'text-teal shadow-lg border hover:bg-transparent':activeMappingTable == `propertyShop&EatMap`}"
                          type="button"
                          class="
                            rounded-md
                            text-base
...
export default {
  ...
  setup(props) {
    ...
    function getMappingIdForContent(e){
      ...
      console.log("Mapping id click:", mappingId);
    }
