                ...
                <div id="#localInformationModule" class="relative my-6">
                  ...
                  <div>
                    ...
                    <div class="block w-full h-56 rounded-lg bg-gray-200 mt-4">
                      <span class="p-4">{{activeMappingTable == "propertyMap" ? "Map Content Coming soon" : activeMappingTable == "propertySchoolMap" ? "School Map content coming soon" : "Shops/Resturants Map coming soon"}}</span>
                    </div>
                  </div>
                </div>
