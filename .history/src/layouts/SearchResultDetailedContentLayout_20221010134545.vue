          ...
          <div
            ...
            <div v-if="!isLoading && propertyDetail[0].lead_forms.form.show" class=" text-gray-700">
              ...
              <div 
                ...
                class="overflow-hidden outline outline-teal-light"
              >
                <ul
                 ref="dateContentWidthRef" class="flex flex-row gap-2 flex-nowrap">
                  <li
                     class="w-1/4"
                  ...
                  >
                    <button
                      v-on:click="getDateContainerWidthRef()"
                      v-bind:class="{
...
export default {
  ...
  setup(props) {
    ...
    const getDateContainerWidthRef = () => {
      ...
      let dateWidth = dateItemRefs.value.forEach( date => date.offsetWidth);
      let dateWidthClient = dateItemRefs.value.forEach( date => date.clientWidth);
      
      console.log("GetoffsetWidthItemRef:", dateWidth);
      console.log("GetclientWidthItemRef:", dateWidthClient);
    };
