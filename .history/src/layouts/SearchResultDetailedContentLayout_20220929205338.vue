        ...
        <table class="table-fixed bg-gray-100  w-full h-auto overflow-hidden text-gray-600 rounded-tl-lg rounded-tr-lg rounded-br-lg rounded-bl-lg">
          ...
          <tbody class="bg-white">
            <tr class="border">
              ...
              <td class="w-auto py-2 px-4 border-t flex">
                <span>Public Record</span>
                <button class="absolute z-10 right-0 top-1/2">
                   <chevron-down 
                  class=" text-gray-600 bg-white border rounded-full hover:shadow-md hover:bg-gray-100 active:bg-gray-300"/>
                </button>
              </td>
            </tr>
