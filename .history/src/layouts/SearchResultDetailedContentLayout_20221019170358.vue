  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div 
        ...
        <table
          v-for="feature in propertyDetail[0].features"
          :key="feature"
          class="
            table-fixed
          bg-teal-lighter
          ...
          <tbody class="bg-white">
            <tr class="w-full flex flex-wrap justify-between border">
              <td
                v-for="textFeature in feature.text"
                :key="textFeature"
        ...
        <span
      v-show="propertyDetail[0].features.length > 2 && !toggleTable"
      class="bg-gradient-to-t from-white h-10 w-full -mt-12"
    >
    </span>
    <button
      v-show="propertyDetail[0].features.length > 2"
