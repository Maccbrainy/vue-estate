            ...
            <div class="contact-form text-gray-700">
              ...
              <div
                ...
                <input
                  ...
                  type="name"
                  v-bind:class="{'transform translate-y-1': focused || getContactValues}"
                  class="outline-none w-full bg-transparent py-4 px-4"
                />
              </div>
              <div class="text-red-600 text-xs p-1">Please enter your first and last name.</div>
            </div>
...
import { SaveSearch, ShareIcon } from "../assets/icons";
...
export default {
  ...
  setup(props) {
    ...
    // watchEffect(() => {
    //   console.log("i am focused:",focused.value);
    // })
    onMounted(() => {
