        ...
        <div id="#contactModule" class="w-4/12 mt-8 max-h-96 relative">
          <div
            ...
            <div v-if="!isLoading && propertyDetail[0].lead_forms.form.show" class=" text-gray-700">
              ...
              <div>
                <ul>
                  <li v-for="date in getDatesRangeInAWeek" :key="date">
                    <button class="border rounded-lg w-1/4 h-auto text-gray-600 text-lg px-3 py-1 flex flex-col justify-center items-center hover:border-teal">
                      <span>{{date.dayOfWeek}}</span>
                      <span class="font-bold">{{date.dayOfMonth}}</span>
