        ...
        <div id="#contactModule" class="w-4/12 mt-8 max-h-96 relative">
          <div
            ...
            <div class="contact-form text-gray-700">
              ...
              <h3 class="flex flex-col my-3">
                <span class="text-sm font-semibold">Leasing Agent</span>
                <span class="text-sm">(510) 288-5187</span>
              </h3>
              <div
                v-bind:class="{
                  'outline-none ring ring-offset-2 ring-offset-white ring-teal-light': focused
                }"
                class="relative border border-gray-500 py-1 rounded-lg">
                <label class="absolute left-4 top-1 font-semibold text-xs text-teal z-10">Name</label>
                <input 
                  v-on:focus="focused = true"
                  v-on:blur="focused = false"
                  v-bind:placeholder="focused ? 'Your Name':''" 
                  v-bind:class="{'transform translate-y-2': focused}"
                  type="name"
                  class="outline-none w-full bg-transparent py-4 pl-4"
                  />
              </div>
            </div>
