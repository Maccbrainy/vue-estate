    ...
    watchEffect(() => {
      ...
      if (
        ...
        if (storeData.value.searchedData.activeRouteTab != "HomePage"){
          updateRouterParams.activeRouteTab = storeData.value.searchedData.activeRouteTab;
   ...
   const isRentsNearMeOrSalesNearMe = computed(() => {
    ...
    onMounted(() => {
      ...
      if (!storeData.value.searchedData){
        let propsCity = isRentsNearMeOrSalesNearMe.value ? defaultCity.value : props.city;
        let propsStateCode = isRentsNearMeOrSalesNearMe.value ? defaultStateCode.value : props.slug;
        
        let searchPayload = {
            city: propsCity,
            state_code: propsStateCode,
            activeRouteTab: storeData.value.activeRoutePath
          };
