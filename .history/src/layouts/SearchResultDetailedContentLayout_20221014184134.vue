    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div id="#propertyDescriptionModule" class="relative my-4">
        <p class="text-xs text-gray-500 font-normal text-justify">
          {{`298 Saint Marks Ave, Brooklyn, NY 11238 is a 6 bedroom, 3 bathroom, 2,700 sqft multi-family built in 1910. 298 Saint Marks Ave is located in Prospect Heights, Brooklyn. This property is currently available for sale and was listed by StreetEasy on Sep 9, 2022.`}}
        </p>
      </div>
    </div>
  </div>
