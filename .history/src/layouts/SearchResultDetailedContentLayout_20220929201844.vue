  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div id="#homePriceHistory" class="relative my-8 flex flex-col">
        ...
        <table class="table-fixed bg-white  w-full h-auto overflow-hidden text-gray-600 rounded-tl-lg rounded-tr-lg rounded-br-lg rounded-bl-lg">
          <thead>
            <tr class="w-full py-3 text-gray-600 bg-gray-100">
