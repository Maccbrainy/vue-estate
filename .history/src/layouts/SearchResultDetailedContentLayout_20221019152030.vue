  ...
  >
          <thead>
            <tr class="w-full py-3 text-gray-600">
              <th
                v-for="title in ['Interior Features']"
                :key="title"
          ...
          <tbody class="bg-white">
            <tr class="w-full flex flex-wrap justify-between list-disc list-inside border">
              <td class="w-auto py-2 px-4">
                This is the dish and basement session
              </td>
              <td class="w-auto py-2 px-4">
                This is the dish and basement session
              </td>
          ...
          <thead>
            <tr class="w-full py-3 text-gray-600 my-2">
              <th
                v-for="title in ['Exterior Features']"
                :key="title"
                class="w-full text-left py-2 px-4"
              >
                {{ title }}
