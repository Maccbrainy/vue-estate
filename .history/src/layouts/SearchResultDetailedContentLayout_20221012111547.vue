          ...
          <div
            ...
            >
              ...
              <div 
                ...
                class="relative outline-none mt-1">
                <button
                ...
                <button
                  v-show="
                    isChevronLeftVisibility == 0 || isChevronRightVisibility
                  "
                ...
                <ul
                  ...
                  <li
                    ...
                    <button
                      ...
                      v-bind:id="date"
                      v-bind:class="{
                        'border-2 border-teal-light hover:border-teal-light': index == isActiveDate,
...
export default {
  ...
  setup(props) {
    ...
    const getDatesRangeInAWeek = computed(() => {
      ...
      while( date <= endDate){
          ...
          dates.push({
            ...
            rawDate: thisDate
            // timeOfDay: function (thisDate){

            //   const timesOfTheDay = [];
            //   const startDayTime = isFuture(thisDate) ? new Date(thisDate.setHours(9,0,0,0)) : new Date(thisDate.setHours(11,0,0,0));
            //   const endDayTime = new Date(thisDate.setHours(19,0,0,0));
    ...
    const moveSlide = (direction) => {
      ...
      isChevronRightVisibility.value = remainderOfOverAllScrollWidthLength > contentWidthTheVisibleArea ? true : false;
    ...
    const getDateAndTime = (_, date, index) => {
      ...
      const timesOfTheDay = [];
      const startDayTime = isFuture(date.rawDate) ? new Date(date.rawDate.setHours(9,0,0,0)) : new Date(date.rawDate.setHours(11,0,0,0));
      const endDayTime = new Date(date.rawDate.setHours(19,0,0,0));
      ...
      console.log("Time Main:", timesOfTheDay);
      console.log("Date Main:", date);
    ...
    watchEffect(() => {
      // const timesOfTheDay = [];
      // const startTime = new Date(new Date().setHours(11,0,0,0));
      // const endTimeToday = new Date(new Date().setHours(19,0,0,0));

      // const time = new Date(startTime.getTime());

      // while( time <= endTimeToday){
      //   let thisTime = new Date(time);
      //   timesOfTheDay.push({
      //     time: format(thisTime, "hh:mm a")
      //   });
      ...
      // console.log("startTime", format(startTime, "hh:mm a"));
      // console.log("endTimeToday", format(endTimeToday, "hh:mm a"));
      // console.log("timesOfTheDay", timesOfTheDay);
