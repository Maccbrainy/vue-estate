<template>
  ...
  >
    ...
    <widget-image-grid
      ...
      v-bind:propertyImages="contextProvider.photos"
    >
    </widget-image-grid>
        ...
        >
          <div class="absolute w-full">
            <div class="text-gray-700 text-lg font-semibold py-3 px-3">
              {{ `Listing Photos (${contextProvider.photos.length})` }}
            </div>
            <div class="flex flex-wrap">
              <div
                v-for="(photo, index) in contextProvider.photos"
                :key="index"
...
export default {
  ...
  setup(props) {
    ...
    watchEffect(async () => {
      ...
      contextProvider.value.photos = propertyDetail.value[0].photos;
