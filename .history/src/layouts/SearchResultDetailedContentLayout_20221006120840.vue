<template>
  ...
  <teleport v-if="isMediaTable" to="body">
    ...
    >
      <div
        ref="mediaTableRef"
        class="w-11/12 h-5/6 bg-white m-auto relative -bottom-14 rounded-lg overflow-hidden"
      >
        ...
        <div class="relative w-8/12">
          ...
          <div class="block w-full h-auto overflow-y-scroll rounded-lg bg-gray-200 ml-3">
