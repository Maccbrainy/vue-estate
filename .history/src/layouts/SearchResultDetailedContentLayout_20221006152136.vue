    ...
    >
      ...
      >
        <div class="fixed w-11/12 z-10 bg-white">
          ...
          />
          <div class="text-gray-700 text-base font-semibold px-2 py-1">
            <div>
              {{
        ...
        <div class="relative w-8/12 h-full top-24 overflow-y-auto pb-2">
          <div class="absolute w-full rounded-lg">
            <div class="text-gray-700 text-lg font-semibold py-3 px-1">
            ...
            <div class="flex flex-wrap">
              <div
                ...
                :key="index"
                class="flex-initial border-4 border-solid border-transparent"
              >
                <picture>
                  <img
