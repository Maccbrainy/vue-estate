  ...
  >
    ...
    <div class="w-9/12 mx-auto px-4">
      ...
      <div id="#homePriceHistory" class="relative my-8 flex flex-col">
        ...
        <table class="table-fixed w-full h-auto border rounded-tl-lg rounded-tr-lg rounded-bl-lg rounded-br-lg">
          <thead>
            <tr class="w-full bg-gray-100 py-3 text-gray-600 rounded-tl-lg rounded-tr-lg">
