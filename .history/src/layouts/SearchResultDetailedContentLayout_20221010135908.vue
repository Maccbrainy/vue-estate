...
export default {
  ...
  setup(props) {
    ...
    const getDateContainerWidthRef = () => {
      ...
      console.log("GetAllclientWidthItemRef:", dateItemRefs.value.$el.clientWidth);


      let dateWidth = dateItemRefs.value.forEach( date => date.$el.offsetWidth);
      let dateWidthClient = dateItemRefs.value.forEach( date => date.$el.clientWidth);
