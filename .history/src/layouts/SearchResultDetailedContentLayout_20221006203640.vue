          ...
          <div class="flex flex-col my-3">
            <div class="flex flex-wrap">
              ...
              <div class="block w-full">
                <div 
                  ref="localRef" id="localInformationModule" class="relative my-6">
...
export default {
  ...
  setup(props) {
    ...
    const getId = document.getElementById("localInformationModule");
    window.onscroll = function(){
      console.log("This is Window height:",window.pageYOffset);
      // console.log("The height localInformationModule offsetTop:",getId.offsetTop);
      // console.log("The height localInformationModule offsetHeight:",getId.offsetHeight);
      // console.log("The height localInformationModule scrollTop:",getId.scrollTop);
    }
    ...
    function activateBar(){
      console.log("This is Window height:",window.pageYOffset);
      console.log("This is Window localRef:",localRef.value.scrollTop);
      if (window.pageYOffset > 300) {
        console.log("show sticky navbar");
      }else {
        console.log("sticky navbar hidden");
      }
    }
    onMounted(() => {
      document.addEventListener("mousedown", closeOnOutsideClick);
      document.addEventListener("touchstart", closeOnOutsideClick);
      document.addEventListener("scroll", activateBar);
    });

    onUnmounted(() => {
      document.removeEventListener("mousedown", closeOnOutsideClick);
      document.removeEventListener("touchstart", closeOnOutsideClick);
      document.removeEventListener("scroll", activateBar);
    });
