      ...
      <div id="#homePriceHistory" class="relative my-8 flex flex-col">
        ...
        >
          ...
          <tbody class="bg-white">
            <tr
              v-for="propertyHistory in propertyHistoryContentToShowAtDefault"
        ...
        <span class="bg-gradient-to-t from-black h-10 w-full -mt-12"> </span>
        <button
...
export default {
  ...
  setup(props) {
    ...
    const propertyHistoryContentToShowAtDefault = computed(() => {
      let historyData;
    ...
    return {
      ...
      propertyDetail,
      descriptionContentToShowAtDefault,
      propertyHistoryContentToShowAtDefault,
