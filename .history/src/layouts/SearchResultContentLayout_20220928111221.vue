  ...
  setup(props) {
    ...
    const activeFilterDescriptionEnteries = computed(() => {
      ...
      let filterEntries = {
        ...
        homeType3rd: removeUnderScoresFromAString(storeData.value.propertyFilters.homeType[1]), 
        homeType4th: removeUnderScoresFromAString(storeData.value.propertyFilters.homeType[1]), 
        ...
        homeFeatures4th: removeUnderScoresFromAString(storeData.value.propertyFilters.features[2]),
