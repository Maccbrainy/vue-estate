      ...
      <div class="w-9/12 mx-auto px-4">
        <div class="flex justify-between py-2">
          <div class="flex flex-col">
            <div class="text-xl font-semibold text-gray-700">{{propertyAddress}}</div>
            <div class="text-gray-500">{{ `${propertyCity}, ${slug}  ${postalCode}` }}</div>
          </div>
          <div class="text-2xl font-semibold text-gray-700">{{`$${propertyPrice}`}}</div>
          <div></div>
        </div>
      </div>
    </div>
