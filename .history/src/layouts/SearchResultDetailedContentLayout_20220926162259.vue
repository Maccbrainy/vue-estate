          ...
          <div class="flex flex-col my-3">
            <div class="flex flex-wrap">
              ...
              <div class="block w-full">
                <div id="#localInformation" class="my-6">
                  ...
                  <div>
                    ...
                    <div class="w-full h-56 rounded-lg bg-gray-200 mt-4"></div>
                  </div>
                </div>
                <div id="#description" class="my-6">
                  <div class="text-gray-700 font-bold text-xl my-4">Description</div>
                  <p class="text-gray-700 text-base">{{ propertyDetail[0].description }}</p>
                </div>
              </div>
            </div>
          </div>
