  ...
  >
    ...
    >
      <div
        ...
        class="w-full lm:max-w-5xl mx-auto px-4"
      >
        <div class="flex justify-between mt-2">
          ...
          <widget-save-share 
            class="space-x-4 transform translate-x-20">
          </widget-save-share>
          <button
            type="button"
        ...
        <div
          ...
          "
        >
          <widget-contact-form v-if="false"
    ...
    <div class="w-full lm:max-w-5xl mx-auto px-4">
      <div class="flex justify-between flex-wrap">
              ...
              <div class="max-w-md sf:pb-5">
                <div>
                  <h1 class="flex flex-col">
                    <span class="text-3xl text-gray-700 font-bold sf:text-xl">
                      {{ propertyAddress }}
                    </span>
              ...
              <div class="max-w-xs">
                ...
                >
                  <div v-show="contextProvider.price">
                    <h3 class="text-3xl text-gray-700 font-bold inline-flex sf:text-xl">
                      ${{ contextProvider.price }}
                    </h3>
        ...
        <div id="#contactModule" class="max-w-xs mt-8 max-h-96 relative mf:hidden">
          <div
            class="
              block
              w-full
          ...
          >
            ...
            <div id="#RequestForTourModule" class="text-center">
              ...
              <button
                ...
                "
                v-bind:class="{
                  'border-red-600 bg-red-600 text-white hover:bg-transparent hover:text-red-600': index == 0, 
      ...
      <widget-history-table v-if="!isLoading"
      ...
      <div id="#propertyDescriptionModule" class="relative my-4 top-12">
        <p v-if="propertyDetail.length > 0" class="text-xs text-gray-500 font-normal text-justify">
          {{`${propertyAddress}, ${propertyCity}, ${slug} ${postalCode} is a ${contextProvider.bed == 0 ? 'Studio,' : `${contextProvider.bed} bedroom,`} ${contextProvider.bath > 0 ? `${contextProvider.bed} bathroom,` : ""} ${contextProvider.sqft ? `${contextProvider.sqft} sqft,` : ""} ${removeUnderScoresFromAString(propertyDetail[0].prop_type)} built in ${propertyDetail[0].year_built}. ${propertyAddress} is located in ${propertyDetail[0].address.neighborhood_name}, ${propertyCity}. This property is currently available ${removeUnderScoresFromAString(propertyDetail[0].prop_status)} and was listed by Realtor on ${format(new Date(propertyDetail[0].list_date),"EEEE MMMM d")}.`}}
        </p>
      </div>
    </div>
  </div>
...
import { ref, watchEffect, computed, onMounted, onUnmounted, provide } from "vue";
...
import WidgetPropertyDetailedTable from "@/components/WidgetPropertyDetailedTable.vue";
...
export default {
  ...
  setup(props) {
    ...
    watchEffect(async () => {
      ...
      contextProvider.value.clientFlags = propertyDetail.value[0].client_display_flags;
      ...
      contextProvider.value.bedMin = isCommunityARentalProperty
        ...
        contextProvider.value.bath = Object.hasOwn(propertyDetail.value[0], "baths")
      ...
      contextProvider.value.mortgageRateUrl = isPropertyMortgaged
        ...
        : "";
      contextProvider.value.priceHistory = propertyDetail.value[0].property_history;
    ...
    return {
      ...
      propertyPhotos,
      // contextProvider.bed,
      // contextProvider.bedMin,
      // contextProvider.bedMax,
      // contextProvider.bath,
      // contextProvider.bathMin,
      // contextProvider.bathMax,
      // contextProvider.sqft,
