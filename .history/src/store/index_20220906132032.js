...
export default createStore({
  ...
  mutations: {
    ...
    setUpdateRouteParams(_, routePayload){
      // state.isLoading = true;
      useRouterPush(routePayload);
      // let pMin = routePayload.priceMin ? `${routePayload.priceMin}_pMin` : "";
      // let pMax = routePayload.priceMax ? `-${routePayload.priceMax}_pMax` : "";
      // let bedQ = routePayload.bed ? `${routePayload.bed}_bd` : "";
      // let homeTypeQ = 
      //   routePayload.homeType ? routePayload.homeType : "";
      // let bathQ = routePayload.bath ? `${routePayload.bath}_bath` : "";
      // console.log("queryLoad content Route:", routePayload.routeName);
