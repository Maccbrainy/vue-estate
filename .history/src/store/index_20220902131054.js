...
export default createStore({
  ...
  mutations: {
    ...
    setUpdateRouteParams(_, routePayload){
      // state.isLoading = true;
      let price = routePayload.price ? routePayload.price : "";
      let bed = routePayload.bed ? routePayload.bed : "";
      let homeType = routePayload.homeType ? routePayload.homeType.join() : "Hahahah";
      let bath = routePayload.bath ? routePayload.bath : "";
