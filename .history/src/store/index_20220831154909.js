...
export default createStore({
  ...
  getters: {
    ...
    async getIsActiveRouteTab(state){
      const activeRoute = await localForage.getItem('IS_ACTIVE_ROUTE');
      return state.activeRoutePath ? state.activeRoutePath : activeRoute;
    },
  },
  mutations: {
    ...
    setActiveRoutePath(state, routePayload){
      ...
      localForage.setItem('IS_ACTIVE_ROUTE', routePayload);
    },
