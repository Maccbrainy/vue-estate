...
export default createStore({
  ...
  mutations: {
    ...
    setUpdateRouteParams(_, routePayload){
      // state.isLoading = true;
      let price = routePayload.price ? routePayload.price : "yesPrice";
      let bed = routePayload.bed ? routePayload.bed : "yesBed";
      let homeType = routePayload.homeType 
        ? routePayload.homeType.length : "yesType";
      let bath = routePayload.bath ? routePayload.bath : "yesBath";
      console.log("queryLoad price:", price);
      console.log("queryLoad bed:", bed);
      console.log("queryLoad homeType:", homeType);
      console.log("queryLoad bath:", bath);
      // useRouterPush(routePayload);
      // router.push({
      //   query: {
      //    price:"", 
