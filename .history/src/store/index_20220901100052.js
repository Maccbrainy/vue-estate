...
export default createStore({
  ...
  getters: {
    ...
    getIsActiveRouteEndPointQueryName(state){
      return state.activeRoutePathEndPointQuery;
    },
  },
  mutations: {
