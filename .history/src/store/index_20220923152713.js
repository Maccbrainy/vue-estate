...
function getDefaultPropertyFilterPriceRanges(){
  return {
    priceMinRange: null,
    priceMaxRange: null,
  }
...
export default createStore({
  ...
  mutations: {
    ...
    //Invoked in FIlterCorePrice Components
  ...
  actions: {
    resetPropertyFilterState({ commit}){
      ...
      // commit("setResetFilterDescriptionInfo");
    },
    resetFilterPriceRange({commit}){
      commit("setResetFilterPriceRanges");
    }
  },
  modules: {},
});
